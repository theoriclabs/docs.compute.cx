---
title: First run
description: Dry-run a tiny MLP, then execute it on RunPod Secure H100-SXM.
---
...
Admission and spend caps can block new runs even with a positive balance. `compute doctor --json` and the error body include a request id — send that to [Support](/support).
