...
Same file is hosted with this manual at [https://docs.compute.cx/SKILL.md](https://docs.compute.cx/SKILL.md).
...
2. Writes the tested [`simple_mlp.py`](/examples/simple_mlp.py) example from [First run](/get-started/first-run).
