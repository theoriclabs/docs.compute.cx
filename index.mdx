...
<Card title="Use with an agent" href="/get-started/agent-skill" icon="robot" horizontal>
  Point Cursor, Claude Code, or Codex at [https://compute.cx/SKILL.md](https://compute.cx/SKILL.md), or add the [MCP server](/get-started/mcp). `--dry-run` creates no machine; a real run spends prepaid credit.
</Card>
...
| Tinker-compatible training API | Private alpha — CLI shipped; public session quotes remain closed until provider canaries pass |
...
<Card title="Tinker-compatible training API" href="/tinker" icon="flask" horizontal>
...
<CardGroup cols={3}>
  ...
  <Card title="Agent Skill" href="/get-started/agent-skill" icon="robot">
    Spend-aware workflow for coding agents. MCP: [connect the server](/get-started/mcp).
  </Card>
</CardGroup>
